            ...
            <div className="flex gap-[16px]">
              {liveLink && (
                <Button
                  ...
                  onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.open(liveLink, '_blank'); }}
                  primary={true}
                >
                  {'Live <~>'}
                </Button>
              ...
              {codeLink && (
                <Button onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.open(codeLink, '_blank'); }}>{'Github >='}</Button>
              )}
            </div>
          </div>
        </div>
